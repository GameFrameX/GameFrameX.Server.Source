...
🌐 **언어**: [English](README_EN.md) | [简体中文](README.md) | [繁體中文](README.zh-TW.md) | [日本語](README.ja.md) | **한국어**
...
본 프로젝트는 **MIT 라이선스**와 **Apache License 2.0**의 듀얼 라이선스로 배포됩니다. 자세한 내용은 [LICENSE](LICENSE) 파일을 참조하세요.
