...
/// </para>
/// </summary>
public enum OnlineIdentityKind
{
    /// <summary>用户名口令身份（存量 LoginState 迁移主通道）。</summary>
    UserName = 1,

    /// <summary>邮箱身份。</summary>
    Email = 2,

    /// <summary>设备标识身份（仅识别用途，不充当 PlayerId）。</summary>
    Device = 3,

    /// <summary>渠道身份（渠道号 + 渠道侧标识）。</summary>
    Channel = 4,

    /// <summary>第三方平台身份。</summary>
    ThirdParty = 5,
}
