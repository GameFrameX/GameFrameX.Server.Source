...
/// </para>
/// </summary>
public interface IOnlineIdempotencyAuditSink
{
    /// <summary>
    /// 记录一次幂等判定审计。
    /// </summary>
    ...
    /// <returns>完成通知（实现不得抛出阻断业务路径的异常）。</returns>
    Task RecordAsync(OnlineIdempotencyAuditRecord record, CancellationToken cancellationToken = default);
}
