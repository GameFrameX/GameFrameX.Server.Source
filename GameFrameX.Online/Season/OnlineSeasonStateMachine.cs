...
public static class OnlineSeasonStateMachine
{
    ...
    public static bool TryTransition(OnlineSeasonState from, OnlineSeasonState to)
    {
    ...
    public static IReadOnlyList<OnlineSeasonState> GetLegalTargets(OnlineSeasonState from)
    {
        return Adjacency.TryGetValue(from, out var targets) ? targets : new OnlineSeasonState[0];
    }
    ...
    public static bool IsTerminal(OnlineSeasonState state)
    {
