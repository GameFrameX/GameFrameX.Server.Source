...
namespace GameFrameX.StartUp.ServiceDefaults
{

    /// <summary>
    /// 服务默认配置扩展（原 Aspire ServiceDefaults 项目，C153 迁入本模块）：服务发现、弹性、健康检查和 OpenTelemetry。
    /// 参考文档：https://aka.ms/dotnet/aspire/service-defaults
    /// </summary>
